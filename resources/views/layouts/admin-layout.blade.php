            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Account Settings">Room Management</div>
                    </a>
                <ul class="menu-sub">
                    <li class="menu-item">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Account Settings">Reservations</div>
                    </a>
                <ul class="menu-sub">
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('reservationLogs') }}" class="menu-link">
                            <div data-i18n="Notifications">Logs</div>
                        </a>
                    </li>
                </ul>
                </li>
